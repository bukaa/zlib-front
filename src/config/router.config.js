...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      // account
      {
        ...
        name: 'account',
        meta: { title: 'menu.account', icon: 'user', keepAlive: true, hideHeader: true, hidden: true, permission: ['user'] },
        children: [
          {
            path: '/account/center',
            name: 'center',
            component: () => import('@/views/account/center'),
            meta: { title: 'menu.account.center', keepAlive: true, hideHeader: true, hidden: true, permission: ['user'] }
          },
          {
            path: '/account/settings',
            name: 'settings',
            component: () => import('@/views/account/settings/Index'),
            meta: { title: 'menu.account.settings', hideHeader: true, hidden: true, permission: ['user'] },
